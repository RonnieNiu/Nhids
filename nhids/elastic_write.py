...
def WriteInputElastic(final_events):
    _create_index()
    for each in final_events:
        print(each,type(each))
        res = helpers.bulk(es,json.loads(each),index=setting.NHIDS_INDEX)
    print(res)
